 ...
 * md is 46px [BG25 p.57], which also clears the 44px hit-target minimum.
 */
export function IconButton({
  ...
  const variants = {
    ...
    subtle:  { background: 'var(--pat-navy-25)', color: 'var(--pat-navy)' },
  };
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={onClick}
      onMouseEnter={(e) => { if (!disabled && variant === 'ghost') e.currentTarget.style.background = 'var(--pat-navy-25)'; }}
